	...
	<div class="fadeout">
		<div class="container">
			<div class="col-md-6 p-lg-5 mx-auto my-5">
				<h1>Crédits<span class="text-warning"> & </span>Remerciements</h1>
			</div>
		</div>
	</div>
</div>
...
<main class="bg-parchment" role="main">
    <div class="container">
        ...
        <div class="chatBox mt-4">
            <img src="/assets/img/credits/ChatBox.png" alt="#" class="responsiveCredits">
            <div class="chatBoxAjust">
                <h2 class="space-card-title mt-n5 mb-4 text-dark">Remerciements</h2>
                <div class="row">
